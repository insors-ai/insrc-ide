...
const REVIEW_ROLE = [
	...
	'                  correctly. ALSO USE THIS when the answer is',
	'                  genuinely null AND the section documents that',
	'                  truthfully with citation (e.g. "the directory',
	'                  contains zero JSON files; the scan ran cleanly,',
	'                  no truncation"). A confirmed-null answer is a',
	'                  REAL answer -- do not punish it.',
	...
	'                  by re-investigation. Section regeneration cannot',
	'                  fix this. ESCALATES to the TODO orchestrator',
	'                  which re-opens the section task tree. Use',
	'                  sparingly. Do NOT use this when:',
	'                    - The per-root findings show a clean null',
	'                      result (zero files, zero matches, etc.) and',
	'                      the section markdown surfaces that with',
	'                      citation. That IS the answer.',
	'                    - The findings show truncation but the LLM is',
	'                      simply summarising loosely -- prefer',
	'                      revise-edits with a "cite the truncation"',
	'                      note.',
	'',
