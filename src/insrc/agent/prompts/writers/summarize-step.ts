...
const ROLE = [
	...
	'',
	'  - LOCAL VARIABLES inside method bodies are NOT class fields. A',
	'    local variable is anything assigned INSIDE a `def ...():` block',
	'    -- `issues = []`, `warnings = []`, `result = {}`, etc. The fact',
	'    that the variable name appears in the class source code does',
	'    NOT make it a field. Example:',
	'',
	'        class INGRN(BaseModel):',
	'            vendor: INPartyDetails = Field(...)        # field',
	'            buyer:  Optional[INPartyDetails] = Field() # field',
	'',
	'            def validate_receiving_compliance(self):   # method',
	'                issues = []                            # LOCAL VAR, not a field',
	'                warnings = []                          # LOCAL VAR, not a field',
	'                if self.totalAmount.amount > 50000:',
	'                    issues.append("...")',
	'                return {"issues": issues, "warnings": warnings}',
	'',
	'    Only `vendor` and `buyer` are class fields. `issues` and',
	'    `warnings` are local variables of the method, and the keys of',
	'    the returned dict are dict keys -- none of these are class',
	'    attributes. NEVER cite a method-body assignment as a field.',
	'',
	'  - Dict / object literal keys (e.g. `{"compliant": ..., "issues":',
	'    issues}` returned from a method) are NOT class fields. They',
	'    are runtime return values; the keys belong to the dict, not',
	'    to the class.',
	'',
	...
	'    line as the verbatim span (NOT the Field() kwarg line, NOT a',
	'    method-body local-variable line, NOT a dict-literal key).',
	'',
