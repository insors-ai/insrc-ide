...
const ROLE = [
	...
	'in real evidence.',
	'',
	'You may OPTIONALLY call one of the available tools BEFORE emitting',
	'your final answer when the Table of Contents lacks what the step',
	'needs and the answer lives in an unindexed file on disk (a config,',
	'a fixture, a directory listing). Each tool call\'s output is',
	'persisted to the artifact store automatically and becomes a NEW TOC',
	'entry the shape-resolver can also fetch.',
	'',
	'Available tools (read-only):',
	'  - `shared.fs.list-files`  : enumerate filesystem entries under a',
	'                              directory. Use when the question is',
	'                              "what files exist under X".',
	'  - `shared.fs.peek`        : read the first N lines / bytes of a',
	'                              text file. Use when the question is',
	'                              "what does the top of file Y look like".',
	'',
	'Tool-use rules:',
	'  - Call a tool ONLY when the TOC does not already carry the',
	'    relevant artifact. Do NOT re-call list-files / peek on a path',
	'    already covered by a TOC entry.',
	'  - At most 2 tool calls per turn. Inline tool calls are slow and',
	...
	'    block (including any NEW entries the tools you just called',
	'    added). DO NOT invent ids. DO NOT paraphrase ids. DO NOT split',
