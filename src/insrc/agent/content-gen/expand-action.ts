...
const SYSTEM_PROMPT_BASE = [
	...
	'     Bare backticks (`identifierName` with no link) are OK only',
	'     for inline keywords / language tokens / entities the evidence',
	'     gives you NO file for. NEVER mention an entity as plain text',
	'     when the evidence carries its file.',
