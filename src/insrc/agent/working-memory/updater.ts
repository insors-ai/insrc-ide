...
// Per-layer updater prompts (COMMON_SYSTEM_HEADER + L2_FALLBACK_RULE +
// SUMMARY_ROLE + RECENT_ROLE + SEMANTIC_ROLE) used to live here as
// Phase 0 cruft -- the prompts now live in
// `agent/prompts/writers/memory-update.ts` and are fetched through the
// PromptRegistry. The inline copies were deleted in the redesign
// follow-up cleanup.
