...
// stripFences moved to agent/tasks/_shared/json-extract.ts so the
// data-analyzer's result parser shares the same prose-preamble
// tolerance without copy-pasting.
