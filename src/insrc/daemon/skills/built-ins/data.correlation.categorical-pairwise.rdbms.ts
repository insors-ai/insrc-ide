...
const CONTEXT_SLOTS: readonly ContextSlotRequest[] = [
	{
		...
		namespace: NAMESPACE,
		query: (req) => {
			const task = (req.task ?? {}) as CorrelationCatInput;
...
function readCachedCorrelationCat(input: CorrelationCatInput, deps: SkillDeps): CorrelationCatOutput | undefined {
...
function pinCorrelationCat(input: CorrelationCatInput, value: CorrelationCatOutput, deps: SkillDeps): void {
