...
//
// Cleanup-trimmed: brainstorm, handoff, access, data-analyzer, chat,
// diff service singletons gone with the corresponding panes. Chat
// service rebuilds in Phase 6 against the new CliProvider.
