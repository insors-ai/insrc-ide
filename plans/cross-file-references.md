...
| Item                                       | Status | Notes |
|--------------------------------------------|--------|-------|
| `source-roots.ts` skeleton + API           | todo   |       |
| Java / Scala manifest source-root parsing  | todo   |       |
| Python source-root probing                 | todo   |       |
| Go module-path detection from go.mod       | todo   |       |
| TS tsconfig `baseUrl` / `paths` parsing    | todo   |       |
| Caching + invalidation on manifest change  | todo   |       |
| Unit tests                                 | todo   |       |
